...
//! @details How many distinct ordered k-elements we can have in a set of N elements.
...
//! @brief Compute the k arrangement in N.
//! @details How many distinct unordered k-elements we can have in a set of N elements.
//! @param[in] n The size of the set.
//! @param[in] k The size of the subset.
...
TupleStat getTupleStat(std::size_t diceNumber, const Die& die, const Tuple& tuple);

//! @brief Contains the number of Roll to strictly have N time a Tuple.
//! @details key: Number of time the Tuple appears; value: the number of possible Roll.
...
//! @param[in] die The Shape of a Die.
//! @param[in] tuple The Tuple to search.
//! @return A map containing the number of Roll to strictly have N time the Tuple.
TupleCount getTupleCount(std::size_t diceNumber, const Die& die, const Tuple& tuple);
*/
